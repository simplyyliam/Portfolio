...
export function Landing_Hero () {
    ...
    useEffect(() => {
        ...
        mm.add("(max-width: 600px)", () => {
            gsap.to(HeroRef.current, {height: 700, width: 400, delay: 0.3})
            gsap.to(HeaderRef.current, {
                scale: 1.5, // Scale the text
                text: "Scaling and Typing!", // Change the text content
                duration: 2,
        ...
        mm.add('(min-width: 769px)', () => {
            gsap.to(HeroRef.current, {height: 700, width: 1300, delay: 0.3})
            gsap.to(HeaderRef.current, {
                scale: 1.5, // Scale the text
                text: "Scaling and Typing!", // Change the text content
                duration: 2,
